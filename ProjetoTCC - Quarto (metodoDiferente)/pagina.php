...
-->
    ...
    <div class="conteudo">
        ...
        <div class="row">
            ...
            <div class="col-7">
                <p class="nomes text-center"><?php echo $_SESSION['usuario']; ?>!</p>
                </p>
                <span class="text-center"><?php echo $_SESSION['profissao']; ?></span>
                <span class="text-center"><?php echo $_SESSION['email']; ?></span>
            </div>
            <div class="col-2">
