...
<div id="menu" class="row text-center ">
    ...
    <div class="conteudo">
        ...
        <div class="row">
            <div class="col-12">
                <img src="img/login2.png" class="usuarios">
                <h3 class="text-center">Escreva seu post</h3>
            </div>
        </div>
        <div class="row">
    ...
    <div class="row">
        <div class="col-12">
            <div class="post text-center">
                <img src="img/cancelar.svg" class="postimg"></a>
                <img src="img/enviar.svg" class="postimg"></a>
